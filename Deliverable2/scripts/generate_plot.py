# overwrite the python script with the correct version
import matplotlib
...
def plot_strong_scaling(csv_file):
    ...
    # --- 3. Plotting ---
    fig, ax = plt.subplots(figsize=(12, 7)) # Use ax for better control
    ...
    # If all 0, default to 0.1, else half the smallest value
    ...
    for i, matrix in enumerate(matrices):
        ...
        for p in processes:
            ...
            if not row.empty:
                ...
                # Log scale hates true 0.0. Bump slightly if needed or let MPL handle it.
        ...
        # We assume standard stacking works, but we force scale later
    ...
    # --- 4. Force Log Scale ---
    ax.set_yscale('log')
    ax.set_ylim(bottom=min_val) # Critical: Sets the "floor" of the log graph
